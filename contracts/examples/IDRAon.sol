...
contract IDRAon {
    ...
    function distribute() public {
        ...
        //totalSeasonPullRequests = 0; // uncomment if minPullRequest constraint is active
    ...
    function gainShare(address subscriber, bytes32 data) public {
        ...
        history[data] = true;
        //totalSeasonPullRequests++; // uncomment if minPullRequest constraint is active
    ...
    function _isDistributionAllowed() internal pure returns (bool) {
        ...
        // return totalShareUnits > minPullRequests && block.timestamp > deadline; // recommended
    }
    ...
    /*
    // Sample of the flow which is mentioned at the bottom of the article about GitHidra
    // Call this function to start a new season, deposit funds and set the constraints variables.
    uint256 public minPullRequests;
    uint256 public totalSeasonPullRequests;
    uint256 public deadline;
    function startNewSeason(uint256 newDeadline, uint256 newMinPullRequests) public payable {
